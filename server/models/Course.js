...
function createDefaultCourses() {
	Course.find({}).exec(function(err, collection) {
		if(collection.length === 0) {
			...
			Course.create({title: 'C# for Non-Sociopaths', featured: true, published: new Date('10/12/2014'), tags: ['C#']}),
			Course.create({title: 'Super Duper Expert C#', featured: false, published: new Date('10/1/2014'), tags: ['C#']}),
			Course.create({title: 'Visual Basic for Visual Basic Developers', featured: false, published: new Date('7/12/2014'), tags: ['VB']}),
			Course.create({title: 'Pedantic C++', featured: true, published: new Date('1/1/2014'), tags: ['C++']}),
			Course.create({title: 'JavaScript for People over 20', featured: true, published: new Date('10/13/2014'), tags: ['JS']}),
			Course.create({title: 'Maintainable Code for Cowards', featured: true, published: new Date('6/22/2014'), tags: ['Coding']}),
			Course.create({title: 'A Survival Guide to Code Reviews', featured: true, published: new Date('5/7/2014'), tags: ['Coding']}),
			...
			Course.create({title: 'How to Deal with Narcissistic Coworkers', featured: true, published: new Date('3/16/2014'), tags: ['Misc']}),
			Course.create({title: 'Death March Coding for Fun and Profit', featured: true, published: new Date('2/13/2014'), tags: ['Coding', 'Misc']})
		}
	});
}
