angular.module('app').controller('mvMainCtrl', function($scope) {
	...
	{name: 'Pedantic C++', featured: true, published: new Date('1/1/2014')},
	{name: 'JavaScript for People over 20', featured: true, published: new Date('10/13/2014')},
	{name: 'Maintainable Code for Cowards', featured: true, published: new Date('6/22/2014')},
	{name: 'A Survival Guide to Code Reviews', featured: true, published: new Date('5/7/2014')},
	...
	{name: 'Code Reviews for Jerks', featured: false, published: new Date('10/1/2014')},
	{name: 'How to Deal with Narcissistic Coworkers', featured: true, published: new Date('3/16/2014')},
	{name: 'Death March Coding for Fun and Profit', featured: true, published: new Date('2/13/2014')}
	]
});